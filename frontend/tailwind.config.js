  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        '3d': '0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06), 0 -1px 0 0 rgba(255, 255, 255, 0.1) inset',
        '3d-hover': '0 10px 25px -5px rgba(0, 0, 0, 0.15), 0 8px 10px -6px rgba(0, 0, 0, 0.1), 0 -1px 0 0 rgba(255, 255, 255, 0.15) inset',
        'elevated': '0 1px 3px rgba(0,0,0,0.12), 0 1px 2px rgba(0,0,0,0.24)',
